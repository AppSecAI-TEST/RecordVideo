...
/**
 * Created by byd_tw on 2017/8/10.
 */
...
public class GridViewAdapter extends ArrayAdapter<String> implements AbsListView.OnScrollListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view;
        if (convertView == null) {
            view = LayoutInflater.from(getContext()).inflate(R.layout.griditem_layout, null);
        } else {
            view = convertView;
        }
        final ImageView photo = (ImageView) view.findViewById(R.id.iv_icon);
